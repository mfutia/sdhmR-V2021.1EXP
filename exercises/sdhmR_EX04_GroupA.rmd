...
# extract buffered points from template & rasterize
  ...
  rang.bufptR <- crop(rasterize(rang.bufSP, t1), rang.bufSP) # t1 is template from above
  rang.bufptR # examine
```
...
# resulting data frame is model training data set; outfile if desired
  ...
  # writeOGR(rang.bufSP, dsn=".", layer="rang.bufSP", driver="ESRI Shapefile")
```

I can't get this to save as shapefile... Others were saved as I went, above. 
