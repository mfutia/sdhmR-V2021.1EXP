...
FullRange <- glm(RANG106 ~ etpt_5+etpt_6+etpt_sprin+exp1nrm+exp3nrm+exp5nrm+mind_yr_av+prad_sw_di+prec_w_hal+prec_winte+rough_1k+tave_s_hal+tave_sprin+tmax_s_hal+tmax_summe+topos, family = binomial, data = range_PPsA_ShortData)
summary(FullRange)
