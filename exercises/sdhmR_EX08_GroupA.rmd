...
Model 2 is my top pick-- it's consistently in the top few models based on these criteria, especially within the set of cross-validated metrics. Model 4 would also be a good pick but is less parsimonious?
...
This is running really slowly, and I'm getting a lot of error messages "extrapolation not allowed". Only 
