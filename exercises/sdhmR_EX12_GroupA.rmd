...
path.root <-"~/University of Vermont/03 Coursework/sdhmR/sdhmR-V2021.1"
  ...
  path.github <- "~/sdhmR-V2021.1/exercises"
...
```
# Question: did I include the right maps? ... Should the last one just include sum=3 and sum=5?
...
save(prob.dom, probSTD.dom, prob.mean, prob.sd, clas.dom, clas.sum, Mean-SDMaps_EX12, ConcordanceMap_EX12, ConcordanceMapsMatrix_EX12, file = "RANGE.ensemble.dom.RData")
