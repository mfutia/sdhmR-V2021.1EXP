...
et5 <- extract(etpt_5, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
et6 <- extract(etpt_6, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
ets <- extract(etpt_sprin, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
exp1 <- extract(exp1nrm, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
exp3 <- extract(exp3nrm, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
exp5 <- extract(exp5nrm, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
mind <- extract(mind_yr_av, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
prad <- extract(prad_sw_di, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
prec1 <- extract(prec_w_hal, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
prec2 <- extract(prec_winte, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
rough <- extract(rough_1k, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
tave1 <- extract(tave_s_hal, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
tave2 <- extract(tave_sprin, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
tmax1 <- extract(tmax_s_hal, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
tmax2 <- extract(tmax_summe, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
topo <- extract(topos, range.PPsA[, c("cell.wgs_x", "cell.wgs_y")])
```
...
range_data_shp <- st_as_sf(range_PPsA_Data, coords = c("tr.wgs_x", "tr.wgs_y"), crs = prj.wgs84, remove = F)

setwd(path.mod2)
save(range_PPsA_Data, range_data_shp, file = "pres_psu_data")
st_write(range_data_shp, dsn = ".", layer = "range_data_shp", driver = "ESRI Shapefile", delete_layer = T, delete_dsn = T)
```
