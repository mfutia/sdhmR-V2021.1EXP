...
#load presence/absence data 
  pres.abs <- get(load("~/University of Vermont/Classes/sdhmR/sdhmR-V2021.1/data/module02/range_pres_psu_data.RData")) 
  head(pres.abs, 2) 
```
...
layers <- c(etpt5, etpt6, etptsprin, exp1nrm, exp3nrm, exp5nrm, mindyrav, pradswdi, precwhal, precwinte, taveshal, tavesprin, tmaxshal, tmaxsumme, rough1k, topos)
...
```{r}
# extract from stack 
  t1 <- raster::extract(rangeDOM, range_PPsA_Data[, c("tr.wgs_x", "tr.wgs_y")])
...
Got the new file from Matt-- it's working!!!
...
# range_PPsA_Data <- cbind(pres.abs, t1)
# 
...
# write out data files if desired
  ...
  save(rangeDOM, file = "rangeDOM.RData") # save .RData - stacked raster
...
Good dataset = range_PPsA_shortdata
